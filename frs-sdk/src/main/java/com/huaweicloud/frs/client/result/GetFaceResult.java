...
/**
 * Result of getting face
 */
public class GetFaceResult extends JSONObj {
    ...
    public String toString() {
        return String.format("{\"faceSetId\":\"%s\",\"faceSetName\":\"%s\",\"faces\":%s}",
                this.faceSetId, this.faceSetName, this.faces.toString());
    }
