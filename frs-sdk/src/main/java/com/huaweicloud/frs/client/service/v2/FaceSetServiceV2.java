...
public class FaceSetServiceV2 {
     ...
     */
    FaceSetServiceV2(FrsAccess service, String projectId) {
    ...
    public CreateFaceSetResult createFaceSet(String faceSetName, Integer faceSetCapacity, CreateExternalFields createExternalFields) throws FrsException, IOException {
        String uri = String.format(FrsConstant.V2.getFaceSetCreateUri(), this.projectId);
    ...
    public GetAllFaceSetsResult getAllFaceSets() throws FrsException, IOException {
        String uri = String.format(FrsConstant.V2.getFaceSetGetAllUri(), this.projectId);
    ...
    public GetFaceSetResult getFaceSet(String faceSetName) throws FrsException, IOException {
        String uri = String.format(FrsConstant.V2.getFaceSetGetOneUri(), this.projectId, faceSetName);
        Response httpResponse = this.service.get(uri, this.projectId);
    ...
    public DeleteFaceSetResult deleteFaceSet(String faceSetName) throws FrsException, IOException {
        String uri = String.format(FrsConstant.V2.getFaceSetDeleteUri(), this.projectId, faceSetName);
